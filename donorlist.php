...
<body>
<form id="form1" name="form1" method="post" action="donorlist.php">
...
$where=" where availability ='yes' ";
if(isset($_REQUEST["Submit"]))
{
$where .= " and City ='".$_REQUEST["txtCityName"]. "'";
}

$q="Select count(*) as T1 from tbldonor ".$where;
...
$p=1;
	...
	{
	$pgnation.="<a href='donorlist.php?pg=$p'>$p </a> | ";
	$p++;
	}

	$p=$_SESSION["pg"];
	$p= ($p-1)*$pgsize;
	$q="Select * from tbldonor ". $where. " limit $p,$pgsize";
